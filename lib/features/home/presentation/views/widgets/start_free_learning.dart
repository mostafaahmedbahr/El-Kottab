...
import 'package:el_kottab/features/free_learning/presentation/views/free_learning_view.dart';
...
class StartFreeLearning extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        AppNav.customNavigator(context: context, screen: FreeLearningView());
      },
